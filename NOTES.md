...
- Иконки: 🧮 matematika, 🧠 pamyat, 🔍 naydi-lishnee, 🤔 zagadki, 🕐 chasy, 🛒 magazin, 🌀 labirint, 🗣️ tatar.
...
- **tatar** — `SETS` (6 тем, `[татарское, русское, эмодзи]`, 50 слов); режим «Учить» (`#studyScreen`, карточки-перевёртыши) и «Квиз» (`#gameScreen`, направление tr/rt чередуется); квиз проходит ВСЕ слова темы. Татарские буквы ә/ө/ү/җ/ң/һ — обычный Unicode.
